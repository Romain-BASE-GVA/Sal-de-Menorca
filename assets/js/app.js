$(document).ready(function () {
    ...
    function topbarColorRotation() {
        ...
        if(isHome){
            ...
            $('.topbar').addClass('topbar--light').removeClass('topbar--dark');
            ...
            $('.topbar').addClass('topbar--dark').removeClass('topbar--light');

            ScrollTrigger.create({
                trigger: 'body',
                start: self => 'top ' + (window.innerHeight / 3 * -1) + 'px',
                invalidateOnRefresh: true,
                refreshPriority: -1000,
                onEnter: () => {
                    $('.topbar').addClass('topbar--is-scrolled');
        ...
        $('.divided').each(function () {
            ...
            var curtainAnim = gsap.timeline({
                scrollTrigger: {
                    ...
                    start: () => {
                        return window.innerWidth >= 768 ? 'bottom bottom' : 'center center'
